...
getConnect();
$selectSQL = "SELECT id, title, type, education, sex, other, content, reward FROM information";
        ...
        <div class="body">
            <div class="aside">
                ...
                <ul class="asideListContent" data-expand="false">
                    ...
                    <li class="asideListItem">删除招聘</li>
            ...
            <div class="content">
                <div class="content_index">用户管理->删除招聘</div>
                    ...
                    <table>
                        ...
                        <form id="input">
                            ...
                            while ($row = mysql_fetch_array($res1)) {
                                echo "<tr><td><input type=\"radio\" value=\"" . $row['id'] . "\" name=\"all_row\"></input></td>
                                    <td>" . $row['title'] . "</td>
                                    <td>" . $row['type'] . "</td>
                                    <td>" . $row['education'] . "</td>
                                    <td>" . $row['sex'] . "</td>
                ...
                <div class="btn_div"><button class="del_button" onclick="delAnnon()">删除</button></div>
            </div>
        </div>
    </div>
