...
function dateinfo(obj){
    var detail='<div id="myJob">'+
                    '<div id="content_abstract">'+
                        '<h1 id="pt_title">'+obj.title+'</h1>'+
                        '<div id="salary">'+obj.reward+'</div>'+
                    '</div>'+
                    '<div id="content_detail">'+
                        '<div class="content_header">'+
                            '<span id="sub_title">兼职详情</span><hr>'+
                        '</div>'+
                        '<div class="row">'+
                            '<span class="sub_title2">【工作内容】</span><br>'+
                            '<span class="sub_content2">'+obj.title+'</span>'+
                        '</div>'+
                        '<div class="row">'+
                            '<span class="sub_title2">【工作要求】</span><br>'+
                            '<span class="sub_content2">'+obj.pjtype+'</span>'+
                        '</div>'+
                        '<div class="row">'+
                        ...
                        '</div>'+
                        '<div class="row">'+
                            '<span class="sub_title2">【报名人数】</span><br>'+
                            '<span class="sub_content2">'+obj.education+'</span>'+
                        '</div>'+
                    '</div>';
...
// }
    ...
    var clickPages={
        ...
        newPages:function (type,i){
            ...
            var HL='<li><a>...</a></li>';
            html='<li><a>&laquo;</a></li><li><a>上一页</a></li>';
            for(var n=0;n<3;n++)
            {
